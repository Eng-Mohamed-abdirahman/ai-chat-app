...
import { Bot, User, Send, AlertCircle, RotateCcw } from 'lucide-react';
...
const Chat = ({ conversationId, initialMessages = [], conversationTitle = "new conversation" }: ChatProps) => {
  ...
  const [input, setInput] = useState<string>(''); // Initialize input as an empty string
                ...
                <div className="bg-red-50 border border-red-200 rounded-2xl px-4 py-3">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-red-600 text-xs">{error.message || 'Please try again'}</p>
                    </div>
                    <Button
                      variant="outline"
                      size="sm"
